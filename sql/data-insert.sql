...
-- Insert data into Airport table (from both Origin and Destination fields)
INSERT INTO Airport (
...
-- Insert data into FlightMetrics table, joining with Flight to get FLIGHT_ID
...
-- Insert distinct City data from Airport into City table
